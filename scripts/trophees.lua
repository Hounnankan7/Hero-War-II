...
function trophee_Draw()
    ...
    love.graphics.print("", 32*tileSize, 20.6*tileSize)
    love.graphics.print("", 32*tileSize, 24.6*tileSize)
    love.graphics.print("", 32*tileSize, 28.6*tileSize)
    ...
    love.graphics.print("", 46*tileSize, 28.6*tileSize)
    love.graphics.print("", 46*tileSize, 32.6*tileSize)
